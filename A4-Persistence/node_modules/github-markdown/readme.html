...
.hljs-strong {
  ...
  <body>
    <div class="container">
      <div class="markdown-body"><h1><a href="https://npmjs.org/package/github-markdown">node-github-markdown</a></h1>
<p><a href="https://travis-ci.org/1000ch/node-github-markdown"><img src="https://travis-ci.org/1000ch/node-github-markdown.svg?branch=master" alt="Build Status"></a>
<a href="http://badge.fury.io/js/github-markdown"><img src="https://badge.fury.io/js/github-markdown.svg" alt="NPM version"></a>
<a href="https://david-dm.org/1000ch/node-github-markdown"><img src="https://david-dm.org/1000ch/node-github-markdown.svg" alt="Dependency Status"></a>
<a href="https://david-dm.org/1000ch/node-github-markdown#info=devDependencies"><img src="https://david-dm.org/1000ch/node-github-markdown/dev-status.svg" alt="devDependency Status"></a></p>
<p>Parse GitHub flavored markdown to static html.</p>
<h2>Installation</h2>
<p>Install via npm.</p>
<pre><code class="hljs bash">$ npm install github-markdown
</code></pre>
<p><code>v2.0.0</code> requires Node.js <code>v4.0.0</code>~. If you are using older version of Node.js, specify the version <code>v1.2.3</code>.</p>
<pre><code class="hljs bash">$ npm install github-markdown@1.2.3
</code></pre>
<h2>Usage</h2>
<p>Install.</p>
<pre><code class="hljs sh">$ npm install -g github-markdown
</code></pre>
<p>Parse markdowns.</p>
<pre><code class="hljs sh">$ ghmd readme.md
</code></pre>
<h3><code>--title</code></h3>
<p>Specify HTML title.</p>
<pre><code class="hljs sh">$ ghmd --title Target target.md
</code></pre>
<h3><code>--dest</code></h3>
<p>Specify the destination file path.</p>
<pre><code class="hljs sh">$ ghmd --dest index.html readme.md
</code></pre>
<h3><code>--template</code></h3>
<p>Specify custom template (defaults to standard template)</p>
<pre><code class="hljs sh">$ ghmd --template custom.jade markdown.md
</code></pre>
<h3><code>--help</code></h3>
<p>Show help message.</p>
<h3><code>--version</code></h3>
<p>Show package version.</p>
<h2>License</h2>
<p>MIT: http://1000ch.mit-license.org</p>
